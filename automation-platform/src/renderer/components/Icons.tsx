 ...
 * Modern, scalable icons to replace emoji throughout the app
 */
...
export const SessionsIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SettingsIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  ...
  >
    ...
    <path d="M12 1v6m0 6v6m5.66-15.66l-4.24 4.24m-2.82 2.82l-4.24 4.24M23 12h-6m-6 0H1m15.66 5.66l-4.24-4.24m-2.82-2.82l-4.24-4.24" />
  </svg>
)
...
export const TestTubeIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
